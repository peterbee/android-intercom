...
public class SessionBuilder {
	 ...
	 * @return The reference to the {@link net.majorkernelpanic.streaming.SessionBuilder}
	 */
	...
	/** Returns a new {@link net.majorkernelpanic.streaming.SessionBuilder} with the same configuration. */
