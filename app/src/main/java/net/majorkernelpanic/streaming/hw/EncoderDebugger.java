...
public class EncoderDebugger {
	...
	/** This {@link net.majorkernelpanic.streaming.hw.NV21Convertor} will do the necessary work to feed properly the encoder. */
	 ...
	 * --withPrefix If set to true, the NAL will be preceeded with 0x00000001.
	 */
