 ...
 * (audio samplingrate, video resolution) and then {@link net.majorkernelpanic.streaming.Session#getSessionDescription()}.<br />
 * 
...
public class Session {
	...
	/** 
	 * The destination set with {@link net.majorkernelpanic.streaming.Session#setDestination(String)} could not be resolved.
	...
	public interface Callback {
		 ...
		 * after calling {@link net.majorkernelpanic.streaming.Session#configure()}.
		 * If an error occurs while configuring the {@link net.majorkernelpanic.streaming.Session},
		 * {@link net.majorkernelpanic.streaming.Session.Callback#onSessionError(int, int, Exception)} will be
		 ...
		 * If an error occurs while starting the {@link net.majorkernelpanic.streaming.Session},
		 * {@link net.majorkernelpanic.streaming.Session.Callback#onSessionError(int, int, Exception)} will be
	...
	/** Returns the underlying {@link net.majorkernelpanic.streaming.audio.AudioStream} used by the {@link net.majorkernelpanic.streaming.Session}. */
	public AudioStream getAudioTrack() {
		return mAudioStream;
	}

	/** Returns the underlying {@link net.majorkernelpanic.streaming.video.VideoStream} used by the {@link net.majorkernelpanic.streaming.Session}. */
	public VideoStream getVideoTrack() {
		return mVideoStream;
	}	

	/**
	 * Sets the callback interface that will be called by the {@link net.majorkernelpanic.streaming.Session}.
	 ...
	 * {@link net.majorkernelpanic.streaming.Session#getVideoTrack()} and {@link net.majorkernelpanic.streaming.video.VideoStream#getFlashState()}.
	 **/
