...
public abstract class MediaStream implements Stream {
	...
	/**
	 * Returns the packetizer associated with the {@link net.majorkernelpanic.streaming.MediaStream}.
	...
	/**
	 * Indicates if the {@link net.majorkernelpanic.streaming.MediaStream} is streaming.
	 * @return A boolean indicating if the {@link net.majorkernelpanic.streaming.MediaStream} is streaming
	 */
